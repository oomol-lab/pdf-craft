...
<div align="center">
  ...
  <p>
    <a href="https://pdfcraft.ai/"><strong>在线体验</strong></a> ·
...
| 使用方式 | 适合谁 | 需要准备 |
| --- | --- | --- |
| **[在线体验](https://pdfcraft.ai/)** | 希望先看看效果的用户 | 浏览器；功能与使用要求以在线应用为准 |
...
[![PDF Craft 在线应用](../images/website-cn.png)](https://pdfcraft.ai/)
