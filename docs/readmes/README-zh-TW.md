...
<div align="center">
  ...
  <p>
    <a href="https://pdfcraft.ai/"><strong>線上體驗</strong></a> ·
...
| 方式 | 適用對象 | 需求 |
| --- | --- | --- |
| **[線上體驗](https://pdfcraft.ai/)** | 希望先看效果的使用者 | 瀏覽器；功能與使用要求以線上應用程式為準 |
...
[![PDF Craft 線上應用程式](../images/website-cn.png)](https://pdfcraft.ai/)
