...
<div align="center">
  ...
  <p>
    <a href="https://pdfcraft.ai/"><strong>Probar en línea</strong></a> ·
...
| --- | --- | --- |
| **[En línea](https://pdfcraft.ai/)** | Quienes quieran probar el resultado | Navegador; funciones y condiciones indicadas en la aplicación en línea |
...
[![PDF Craft en línea](../images/website-en.png)](https://pdfcraft.ai/)
