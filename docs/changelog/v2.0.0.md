...
The 2.0 API exposes `PDFCraft` as the public facade. The old top-level
`transform_markdown` and `transform_epub` compatibility wrappers were removed;
use `PDFCraft.convert_pdf_to_markdown` and `PDFCraft.convert_pdf_to_epub`.
