...
class TocCollection:
    ...
    def _find_raw_toc_item_stack(self, id: int) -> list[RawTocItem]:
        index: int = 0
        current_toc_items: list[RawTocItem] = self._root
        stack: list[tuple[int, list[RawTocItem], RawTocItem]] = []
        while True:
