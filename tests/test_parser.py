...
class TestParseRawMarkdown(unittest.TestCase):
    ...
    def test_basic_allowed_tag(self):
        ...
        self.assertIsInstance(result[0], HTMLTag)
        self.assertEqual(result[0].definition.name, "div")
        self.assertEqual(result[0].children, ["Hello"])
    ...
    def test_nested_allowed_tags(self):
        ...
        self.assertIsInstance(result[0].children[0], HTMLTag)
        self.assertEqual(result[0].children[0].definition.name, "p")
        self.assertEqual(result[0].children[0].children, ["Paragraph"])
    ...
    def test_inline_tag_with_text(self):
        ...
        self.assertIsInstance(result[1], HTMLTag)
        self.assertEqual(result[1].definition.name, "b")
    ...
    def test_self_closing_tag(self):
        ...
        self.assertIsInstance(result[1], HTMLTag)
        self.assertEqual(result[1].definition.name, "br")
    ...
    def test_allowed_attributes(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        attr_dict = dict(result[0].attributes)
    ...
    def test_disallowed_attributes_filtered(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        attr_names = [name for name, _ in result[0].attributes]
    ...
    def test_allowed_url_protocol_https(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        self.assertIn(("href", "https://example.com"), result[0].attributes)
    ...
    def test_allowed_url_protocol_http(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        self.assertIn(("href", "http://example.com"), result[0].attributes)
    ...
    def test_allowed_url_protocol_mailto(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        self.assertIn(("href", "mailto:test@example.com"), result[0].attributes)
    ...
    def test_allowed_relative_url(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        self.assertIn(("href", "/path/to/page"), result[0].attributes)
    ...
    def test_img_tag_with_src(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        self.assertEqual(result[0].definition.name, "img")
        self.assertIn(("src", "https://example.com/image.png"), result[0].attributes)
        self.assertIn(("alt", "Test Image"), result[0].attributes)
    ...
    def test_table_structure(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        self.assertEqual(result[0].definition.name, "table")
        self.assertEqual(len(result[0].children), 1)
        self.assertIsInstance(result[0].children[0], HTMLTag)
        self.assertEqual(result[0].children[0].definition.name, "tr")
    ...
    def test_blockquote_with_cite(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        self.assertEqual(result[0].definition.name, "blockquote")
        self.assertIn(("cite", "https://example.com"), result[0].attributes)
    ...
    def test_details_summary(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        self.assertEqual(result[0].definition.name, "details")
        self.assertEqual(len(result[0].children), 2)
        self.assertIsInstance(result[0].children[0], HTMLTag)
        self.assertEqual(result[0].children[0].definition.name, "summary")
    ...
    def test_html_entities_in_attributes(self):
        ...
        self.assertIn(("title", "<Test>"), result[0].attributes)
    ...
    def test_whitespace_in_tags(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        self.assertIn(("id", "test"), result[0].attributes)
    ...
    def test_boolean_attributes(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        self.assertIn(("open", ""), result[0].attributes)
    ...
    def test_mixed_content_complex(self):
        ...
        self.assertEqual(result[0], "Text before ")
        self.assertIsInstance(result[1], HTMLTag)
        self.assertEqual(result[1].definition.name, "p")
        self.assertEqual(result[2], " text after")
    ...
    def test_video_tag_with_attributes(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        self.assertEqual(result[0].definition.name, "video")
        self.assertIn(("src", "https://example.com/video.mp4"), result[0].attributes)
        self.assertIn(("controls", ""), result[0].attributes)
        self.assertIn(("width", "640"), result[0].attributes)
    ...
    def test_list_structure(self):
        ...
        self.assertEqual(len(result), 1)
        self.assertIsInstance(result[0], HTMLTag)
        self.assertEqual(result[0].definition.name, "ul")
        self.assertEqual(len(result[0].children), 2)
    ...
    def test_nested_same_tags(self):
        ...
        self.assertEqual(len(result[0].children), 1)
        self.assertIsInstance(result[0].children[0], HTMLTag)
        self.assertEqual(result[0].children[0].definition.name, "div")
        self.assertEqual(result[0].children[0].children, ["Inner"])
