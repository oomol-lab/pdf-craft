...
def _create_paragraph(content, page_index: int = 1, order: int = 0) -> TextFlowItem:
    return TextFlowItem(
        role="body",
        level=-1,
        children=[
...
class TestPunctuationNormalize(unittest.TestCase):
    def test_convert_ascii_punctuation_between_han_chars(self):
        ...
        chapter = Chapter(id=1, level=0, flow_items=[paragraph])

        normalize_punctuation_in_chapter(chapter)

        self.assertEqual(
            paragraph.children[0].content[0],
    ...
    def test_skip_english_context(self):
        ...
        self.assertEqual(
            paragraph.children[0].content[0], "hello, world: test; why? sure!"
        )
    ...
    def test_skip_mixed_context(self):
        ...
        self.assertEqual(paragraph.children[0].content[0], "中文， English; English,中文")
    ...
    def test_colon_requires_han_on_both_sides(self):
        ...
        self.assertEqual(paragraph.children[0].content[0], "中文: English")
    ...
    def test_keep_inline_expression_unchanged(self):
        ...
        inline_expr = paragraph.children[0].content[1]
    ...
    def test_apply_to_reference_layouts(self):
        ...
        self.assertEqual(ref_paragraph.children[0].content[0], "注释，内容")
    ...
    def test_skip_asset_content_but_normalize_caption(self):
        ...
        chapter = Chapter(id=1, level=0, flow_items=[StandaloneAsset(asset)])
    ...
    def test_convert_punctuation_across_html_tag_boundary(self):
        ...
        rendered = "".join(
            render_markdown_paragraph(
                children=paragraph.children[0].content,
